...
public abstract class BaseRepository<T>(ElectronicJornalDbContext context) : IRepository<T>
    where T : BaseEntity
{
    ...
    public async Task<IQueryable<T>> GetQueryableAsync(ODataQueryOptions<T> options,
