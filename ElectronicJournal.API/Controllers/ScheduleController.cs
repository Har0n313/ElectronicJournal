...
{
    [HttpPost("Create")]
    public async Task<IActionResult> Create([FromBody] CreateScheduleRequest request, CancellationToken token)
    {
    ...
    [HttpPut("Update")]
    public async Task<IActionResult> Update([FromBody] UpdateScheduleRequest request, CancellationToken token)
    {
    ...
    [HttpGet("GetOdata")]
    public async Task<IActionResult> GetOdata([FromBody] SearchScheduleRequest request, CancellationToken token)
    {
